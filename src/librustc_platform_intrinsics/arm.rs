...
pub fn find(name: &str) -> Option<Intrinsic> {
    ...
    Some(match &name["arm_v".len()..] {
        ...
        "padal_s16" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::I16x4, &::I8x8];
                &INPUTS
            },
            output: &::I16x4,
        ...
        "padal_u16" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::U16x4, &::U8x8];
                &INPUTS
            },
            output: &::U16x4,
        ...
        "padal_s32" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::I32x2, &::I16x4];
                &INPUTS
            },
            output: &::I32x2,
        ...
        "padal_u32" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::U32x2, &::U16x4];
                &INPUTS
            },
            output: &::U32x2,
        ...
        "padal_s64" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::I64x1, &::I32x2];
                &INPUTS
            },
            output: &::I64x1,
        ...
        "padal_u64" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::U64x1, &::U32x2];
                &INPUTS
            },
            output: &::U64x1,
        ...
        "padalq_s16" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::I16x8, &::I8x16];
                &INPUTS
            },
            output: &::I16x8,
        ...
        "padalq_u16" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::U16x8, &::U8x16];
                &INPUTS
            },
            output: &::U16x8,
        ...
        "padalq_s32" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::I32x4, &::I16x8];
                &INPUTS
            },
            output: &::I32x4,
        ...
        "padalq_u32" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::U32x4, &::U16x8];
                &INPUTS
            },
            output: &::U32x4,
        ...
        "padalq_u64" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::U64x2, &::U32x4];
                &INPUTS
            },
            output: &::U64x2,
        ...
        "tbl1_s8" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::I8x8, &::U8x8];
                &INPUTS
            },
            output: &::I8x8,
        ...
        "tbx1_s8" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::I8x8, &::I8x8, &::U8x8];
                &INPUTS
            },
            output: &::I8x8,
        ...
        "tbx1_u8" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::U8x8, &::U8x8, &::U8x8];
                &INPUTS
            },
            output: &::U8x8,
            definition: Named("llvm.arm.neon.vtbx1"),
