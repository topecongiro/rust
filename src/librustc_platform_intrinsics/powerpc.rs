...
pub fn find(name: &str) -> Option<Intrinsic> {
    if !name.starts_with("powerpc") {
        return None;
    }
    Some(match &name["powerpc".len()..] {
        "_vec_perm" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::I32x4, &::I32x4, &::I8x16];
                &INPUTS
            },
            output: &::I32x4,
        ...
        "_vec_mradds" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::I16x8, &::I16x8, &::I16x8];
                &INPUTS
            },
            output: &::I16x8,
        ...
        "_vec_msumubm" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::U8x16, &::U8x16, &::U32x4];
                &INPUTS
            },
            output: &::U32x4,
        ...
        "_vec_msumuhm" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::U16x8, &::U16x8, &::U32x4];
                &INPUTS
            },
            output: &::U32x4,
        ...
        "_vec_msummbm" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::I8x16, &::U8x16, &::I32x4];
                &INPUTS
            },
            output: &::I32x4,
        ...
        "_vec_msumshm" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::I16x8, &::I16x8, &::I32x4];
                &INPUTS
            },
            output: &::I32x4,
        ...
        "_vec_sum4ubs" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::U8x16, &::U32x4];
                &INPUTS
            },
            output: &::U32x4,
        ...
        "_vec_sum4shs" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::I16x8, &::I32x4];
                &INPUTS
            },
            output: &::I32x4,
