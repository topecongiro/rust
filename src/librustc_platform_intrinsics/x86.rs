...
pub fn find(name: &str) -> Option<Intrinsic> {
    ...
    Some(match &name["x86".len()..] {
        "_mm256_abs_epi8" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 1] = [&::I8x32];
                &INPUTS
            },
            output: &::I8x32,
        ...
        "_mm256_abs_epi16" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 1] = [&::I16x16];
                &INPUTS
            },
            output: &::I16x16,
        ...
        "_mm256_abs_epi32" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 1] = [&::I32x8];
                &INPUTS
            },
            output: &::I32x8,
        ...
        "_mm256_adds_epi8" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::I8x32, &::I8x32];
                &INPUTS
            },
            output: &::I8x32,
        ...
        "_mm256_adds_epu8" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::U8x32, &::U8x32];
                &INPUTS
            },
            output: &::U8x32,
        ...
        "_mm256_adds_epi16" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::I16x16, &::I16x16];
                &INPUTS
            },
            output: &::I16x16,
        ...
        "_mm256_adds_epu16" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::U16x16, &::U16x16];
                &INPUTS
            },
            output: &::U16x16,
        ...
        "_mm256_hadd_epi32" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::I32x8, &::I32x8];
                &INPUTS
            },
            output: &::I32x8,
        ...
        "_mm_mask_i32gather_epi32" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 5] = [
                    &::I32x4,
                    {
                        static PTR: Type = Type::Pointer(&::I32, Some(&::I8), true);
                        &PTR
                    },
                    &::I32x4,
                    &::I32x4,
        ...
        "_mm_mask_i32gather_ps" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 5] = [
                    &::F32x4,
                    {
                        static PTR: Type = Type::Pointer(&::F32, Some(&::I8), true);
                        &PTR
                    },
                    &::I32x4,
                    &::I32x4_F32,
        ...
        "_mm_mask_i32gather_epi64" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 5] = [
                    &::I64x2,
                    {
                        static PTR: Type = Type::Pointer(&::I64, Some(&::I8), true);
                        &PTR
                    },
                    &::I32x4,
                    &::I64x2,
        ...
        "_mm_mask_i32gather_pd" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 5] = [
                    &::F64x2,
                    {
                        static PTR: Type = Type::Pointer(&::F64, Some(&::I8), true);
                        &PTR
                    },
                    &::I32x4,
                    &::I64x2_F64,
        ...
        "_mm_maskload_epi32" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [
                    {
                        static PTR: Type = Type::Pointer(&::I32x4, Some(&::I8), true);
                        &PTR
                    },
                    &::I32x4,
                ];
        ...
        "_mm_maskload_epi64" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [
                    {
                        static PTR: Type = Type::Pointer(&::I64x2, Some(&::I8), true);
                        &PTR
                    },
                    &::I64x2,
                ];
        ...
        "_mm256_maskload_epi32" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [
                    {
                        static PTR: Type = Type::Pointer(&::I32x8, Some(&::I8), true);
                        &PTR
                    },
                    &::I32x8,
                ];
        ...
        "_mm256_maskload_epi64" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [
                    {
                        static PTR: Type = Type::Pointer(&::I64x4, Some(&::I8), true);
                        &PTR
                    },
                    &::I64x4,
                ];
        ...
        "_mm_maskstore_epi32" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [
                    {
                        static PTR: Type = Type::Pointer(&::I32, Some(&::I8), false);
                        &PTR
                    },
                    &::I32x4,
                    &::I32x4,
        ...
        "_mm_maskstore_epi64" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [
                    {
                        static PTR: Type = Type::Pointer(&::I64, Some(&::I8), false);
                        &PTR
                    },
                    &::I64x2,
                    &::I64x2,
        ...
        "_mm256_max_epu32" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::U32x8, &::U32x8];
                &INPUTS
            },
            output: &::U32x8,
        ...
        "_mm256_mpsadbw_epu8" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::U8x32, &::U8x32, &::I32_8];
                &INPUTS
            },
            output: &::U16x16,
        ...
        "_mm256_permutevar8x32_ps" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::F32x8, &::I32x8];
                &INPUTS
            },
            output: &::F32x8,
        ...
        "_mm256_addsub_ps" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::F32x8, &::F32x8];
                &INPUTS
            },
            output: &::F32x8,
        ...
        "_mm256_addsub_pd" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::F64x4, &::F64x4];
                &INPUTS
            },
            output: &::F64x4,
        ...
        "_mm256_blendv_ps" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::F32x8, &::F32x8, &::F32x8];
                &INPUTS
            },
            output: &::F32x8,
        ...
        "_mm256_blendv_pd" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::F64x4, &::F64x4, &::F64x4];
                &INPUTS
            },
            output: &::F64x4,
        ...
        "_mm256_cmp_ps" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::F32x8, &::F32x8, &::I8];
                &INPUTS
            },
            output: &::F32x8,
        ...
        "_mm256_cmp_pd" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::F64x4, &::F64x4, &::I8];
                &INPUTS
            },
            output: &::F64x4,
        ...
        "_mm256_cvtpd_epi32" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 1] = [&::F64x4];
                &INPUTS
            },
            output: &::I32x4,
        ...
        "_mm256_cvtps_epi32" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 1] = [&::F32x8];
                &INPUTS
            },
            output: &::I32x8,
        ...
        "_mm256_dp_ps" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::F32x8, &::F32x8, &::I32_8];
                &INPUTS
            },
            output: &::F32x8,
        ...
        "_mm_maskstore_ps" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [
                    {
                        static PTR: Type = Type::Pointer(&::F32, Some(&::I8), false);
                        &PTR
                    },
                    &::I32x4_F32,
                    &::F32x4,
        ...
        "_mm_maskstore_pd" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [
                    {
                        static PTR: Type = Type::Pointer(&::F64, Some(&::I8), false);
                        &PTR
                    },
                    &::I64x2_F64,
                    &::F64x2,
        ...
        "_mm_permutevar_ps" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::F32x4, &::I32x4];
                &INPUTS
            },
            output: &::F32x4,
        ...
        "_mm_permutevar_pd" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::F64x2, &::I64x2];
                &INPUTS
            },
            output: &::F64x2,
        ...
        "_mm256_permutevar_pd" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::F64x4, &::I64x4];
                &INPUTS
            },
            output: &::F64x4,
        ...
        "_mm256_storeu_ps" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [
                    {
                        static PTR: Type = Type::Pointer(&::F32x8, Some(&::U8), false);
                        &PTR
                    },
                    &::F32x8,
                ];
        ...
        "_mm256_storeu_pd" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [
                    {
                        static PTR: Type = Type::Pointer(&::F64x4, Some(&::U8), false);
                        &PTR
                    },
                    &::F64x4,
                ];
        ...
        "_mm256_storeu_si256" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [
                    {
                        static PTR: Type = Type::Pointer(&::U8x32, Some(&::U8), false);
                        &PTR
                    },
                    &::U8x32,
                ];
        ...
        "_mm256_testc_si256" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::U64x4, &::U64x4];
                &INPUTS
            },
            output: &::I32,
        ...
        "_bmi2_bzhi_32" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::U32, &::U32];
                &INPUTS
            },
            output: &::U32,
        ...
        "_bmi2_bzhi_64" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [&::U64, &::U64];
                &INPUTS
            },
            output: &::U64,
        ...
        "_mm_fmadd_ps" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::F32x4, &::F32x4, &::F32x4];
                &INPUTS
            },
            output: &::F32x4,
        ...
        "_mm_fmadd_pd" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::F64x2, &::F64x2, &::F64x2];
                &INPUTS
            },
            output: &::F64x2,
        ...
        "_rdrand16_step" => Intrinsic {
            ...
            output: {
                static AGG: Type = Type::Aggregate(false, {
                    static PARTS: [&'static Type; 2] = [&::U16, &::I32];
                    &PARTS
                });
                &AGG
            },
        ...
        "_rdrand32_step" => Intrinsic {
            ...
            output: {
                static AGG: Type = Type::Aggregate(false, {
                    static PARTS: [&'static Type; 2] = [&::U32, &::I32];
                    &PARTS
                });
                &AGG
            },
        ...
        "_rdrand64_step" => Intrinsic {
            ...
            output: {
                static AGG: Type = Type::Aggregate(false, {
                    static PARTS: [&'static Type; 2] = [&::U64, &::I32];
                    &PARTS
                });
                &AGG
            },
        ...
        "_mm_maskmoveu_si128" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::U8x16, &::U8x16, {
                    static PTR: Type = Type::Pointer(&::U8, None, false);
                    &PTR
                }];
                &INPUTS
            },
        ...
        "_mm_storeu_pd" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [
                    {
                        static PTR: Type = Type::Pointer(&::F64, Some(&::U8), false);
                        &PTR
                    },
                    &::F64x2,
                ];
        ...
        "_mm_storeu_si128" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 2] = [
                    {
                        static PTR: Type = Type::Pointer(&::U8x16, Some(&::U8), false);
                        &PTR
                    },
                    &::U8x16,
                ];
        ...
        "_mm_lddqu_si128" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 1] = [{
                    static PTR: Type = Type::Pointer(&::U8x16, Some(&::I8), true);
                    &PTR
                }];
                &INPUTS
            },
        ...
        "_mm_dp_ps" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::F32x4, &::F32x4, &::I32_8];
                &INPUTS
            },
            output: &::F32x4,
        ...
        "_mm_dp_pd" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::F64x2, &::F64x2, &::I32_8];
                &INPUTS
            },
            output: &::F64x2,
        ...
        "_mm_mpsadbw_epu8" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::U8x16, &::U8x16, &::I32_8];
                &INPUTS
            },
            output: &::U16x8,
        ...
        "_mm_cmpestra" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 5] = [&::I8x16, &::I32, &::I8x16, &::I32, &::I32_8];
                &INPUTS
            },
            output: &::I32,
        ...
        "_mm_cmpistra" => Intrinsic {
            inputs: {
                static INPUTS: [&'static Type; 3] = [&::I8x16, &::I8x16, &::I32_8];
                &INPUTS
            },
            output: &::I32,
