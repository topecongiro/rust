...
impl<'a> Resolver<'a> {
    ...
    fn build_reduced_graph_for_use_tree(
        ...
        let mut module_path: Vec<_> = prefix
            .segments
            .iter()
        ...
        match use_tree.kind {
            ast::UseTreeKind::Simple(mut ident) => {
                ...
                self.add_import_directive(module_path, subclass, use_tree.span, id, vis, expansion);
            }
    ...
    fn build_reduced_graph_for_external_crate_def(&mut self, parent: Module<'a>, child: Export) {
        ...
        match def {
            ...
            Def::StructCtor(..) => {
                ...
                if let Some(struct_def_id) = self.cstore.def_key(def_id).parent.map(|index| DefId {
                    krate: def_id.krate,
                    index: index,
                }) {
