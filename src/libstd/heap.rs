...
pub use alloc::heap::{Alloc, AllocErr, CannotReallocInPlace, Excess, Heap, Layout};
...
pub mod __default_lib_allocator {
    use super::{Alloc, AllocErr, Layout, System};
    use ptr;
    ...
    #[no_mangle]
    #[rustc_std_internal_symbol]
    pub unsafe extern "C" fn __rdl_usable_size(
        layout: *const u8,
        min: *mut usize,
        max: *mut usize,
    ) {
