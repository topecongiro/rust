...
pub fn foreach_symbol_fileline<F>(frame: Frame, mut f: F, _: &BacktraceContext) -> io::Result<bool>
where
...
// libbacktrace.h API
////////////////////////////////////////////////////////////////////////
type backtrace_syminfo_callback = extern "C" fn(
...
type backtrace_full_callback = extern "C" fn(
    data: *mut libc::c_void,
    pc: libc::uintptr_t,
...
type backtrace_error_callback =
    extern "C" fn(data: *mut libc::c_void, msg: *const libc::c_char, errnum: libc::c_int);
...
extern "C" fn error_cb(_data: *mut libc::c_void, _msg: *const libc::c_char, _errnum: libc::c_int) {
    // do nothing for now
}
