...
use fmt::{self, Debug};
#[allow(deprecated)]
use hash::{BuildHasher, Hash, Hasher, SipHasher13};
use iter::{FromIterator, FusedIterator};
use mem::{self, replace};
use ops::{Deref, InPlace, Index, Place, Placer};
use ptr;
use sys;
...
#[unstable(feature = "collection_placement",
           reason = "struct name and placement protocol is subject to change", issue = "30172")]
