...
pub fn trans_intrinsic_call<'a, 'tcx>(
    ...
    let llval = match name {
        ...
        "discriminant_value" => args[0].deref(bx.cx).trans_get_discr(bx, ret_ty),
            ...
            fn modify_as_needed<'a, 'tcx>(
                ...
                match *t {
                    ...
                    intrinsics::Type::Vector(_, Some(ref llvm_elem), length) => {
                        let llvm_elem = one(ty_to_type(bx.cx, llvm_elem));
                        vec![
                            bx.bitcast(arg.immediate(), Type::vector(&llvm_elem, length as u64)),
                        ]
                    }
                    intrinsics::Type::Integer(_, width, llvm_width) if width != llvm_width => {
                        ...
                        vec![
                            bx.trunc(arg.immediate(), Type::ix(bx.cx, llvm_width as u64)),
                        ]
                    }
                    _ => vec![arg.immediate()],
                }
