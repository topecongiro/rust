...
pub fn file_metadata(cx: &CodegenCx, file_name: &FileName, defining_crate: CrateNum) -> DIFile {
    debug!(
...
fn file_metadata_raw(cx: &CodegenCx, file_name: &str, directory: &str) -> DIFile {
...
fn basic_type_metadata<'a, 'tcx>(cx: &CodegenCx<'a, 'tcx>, t: Ty<'tcx>) -> DIType {
...
impl<'tcx> MemberDescriptionFactory<'tcx> {
    fn create_member_descriptions<'a>(&self, cx: &CodegenCx<'a, 'tcx>) -> Vec<MemberDescription> {
        match *self {
...
pub fn create_global_var_metadata(cx: &CodegenCx, node_id: ast::NodeId, global: ValueRef) {
