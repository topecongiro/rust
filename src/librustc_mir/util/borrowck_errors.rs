...
pub trait BorrowckErrors {
    ...
    fn struct_span_err<'a, S: Into<MultiSpan>>(&'a self, sp: S, msg: &str)
        -> DiagnosticBuilder<'a>;
    ...
    fn cannot_move_when_borrowed(&self, span: Span, desc: &str, o: Origin) -> DiagnosticBuilder {
    ...
    fn cannot_move_into_closure(&self, span: Span, desc: &str, o: Origin) -> DiagnosticBuilder {
        let err = struct_span_err!(
            self,
            span,
            E0504,
    ...
    fn cannot_reassign_immutable(&self, span: Span, desc: &str, o: Origin) -> DiagnosticBuilder {
        let err = struct_span_err!(
            self,
            span,
            E0384,
    ...
    fn cannot_assign_static(&self, span: Span, desc: &str, o: Origin) -> DiagnosticBuilder {
