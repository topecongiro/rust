...
use common::{C_bool, C_i32, C_null, C_u32, C_u64, C_u8, C_uint, C_uint_big, C_undef, C_usize};
use consts;
use monomorphize;
use type_::Type;
...
impl<'a, 'tcx> FunctionCx<'a, 'tcx> {
    pub fn codegen_rvalue(
        ...
        debug!(
            "codegen_rvalue(dest.llval={:?}, rvalue={:?})",
            Value(dest.llval),
            rvalue
        );
...
fn cast_int_to_float(
    ...
    if is_u128_to_f32 {
        ...
        const MAX_F32_PLUS_HALF_ULP: u128 =
