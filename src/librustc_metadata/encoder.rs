...
use rustc::middle::cstore::{EncodedMetadata, EncodedMetadataHash, EncodedMetadataHashes, LinkMeta,
                            LinkagePreference, NativeLibrary};
...
impl<'a, 'tcx> EncodeContext<'a, 'tcx> {
    ...
    fn encode_codemap(&mut self) -> LazySeq<syntax_pos::FileMap> {
        ...
        let adapted = all_filemaps
            ...
            .map(|filemap| {
                ...
                if filemap.name_was_remapped || (name.is_relative() && working_dir_was_remapped) {
    ...
    fn encode_crate_root(&mut self) -> Lazy<CrateRoot> {
        ...
        let tcx = self.tcx;
        let global_metadata_def_index =
            move |kind: GlobalMetaDataKind| kind.def_index(tcx.hir.definitions().def_path_table());
            ...
            hir::ItemAutoImpl(..) => {
                let data = ImplData {
                    ...
                    trait_ref: tcx.impl_trait_ref(def_id)
                        .map(|trait_ref| self.lazy(&trait_ref)),
                };
