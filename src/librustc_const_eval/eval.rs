        ...
        hir::ExprUnary(hir::UnNeg, ref inner) => {
            ...
            if let hir::ExprLit(ref lit) = inner.node {
                ...
                let negated = match (&lit.node, &ty.sty) {
                    ...
                    | (&LitKind::Int(n, Signed(IntTy::Isize)), _) => match tcx.sess.target.isize_ty
                    {
...
fn cast_const_int<'a, 'tcx>(
    ...
    match ty.sty {
        ...
        ty::TyInt(ast::IntTy::Isize) => Ok(Integral(Isize(ConstIsize::new_truncating(
            v as i128,
        ...
        ty::TyUint(ast::UintTy::Usize) => Ok(Integral(Usize(ConstUsize::new_truncating(
            v,
