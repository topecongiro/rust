    ...
    let (n_tps, inputs, output) = if name.starts_with("atomic_") {
        ...
        let (n_tps, inputs, output) = match &name[..] {
            ...
            "size_of_val" | "min_align_of_val" => (
                ...
                vec![
                    tcx.mk_imm_ref(
                        tcx.mk_region(ty::ReLateBound(ty::DebruijnIndex::new(1), ty::BrAnon(0))),
                        param(0),
                    ),
                ],
                tcx.types.usize,
            ...
            "unchecked_div" | "unchecked_rem" => (1, vec![param(0), param(0)], param(0)),
...
pub fn check_platform_intrinsic_type<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>, it: &hir::ForeignItem) {
    ...
    let (n_tps, inputs, output) = match &*name {
        ...
        | "simd_shr" | "simd_and" | "simd_or" | "simd_xor" => {
            (1, vec![param(0), param(0)], param(0))
        }
