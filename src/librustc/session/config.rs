    ...
    pub fn file_path_mapping(&self) -> FilePathMapping {
        FilePathMapping::new(
            self.debugging_opts
                ...
                .iter()
                .zip(self.debugging_opts.remap_path_prefix_to.iter())
...
pub fn build_session_options_and_crate_config(
            ...
            early_error(
                ...
                &format!(
                    "option `-Zremap-path-prefix-from='{}'` does not have \
                     a corresponding `-Zremap-path-prefix-to`",
                    source
                ),
            )
        }
            ...
            early_error(
                ...
                &format!(
                    "option `-Zremap-path-prefix-to='{}'` does not have \
                     a corresponding `-Zremap-path-prefix-from`",
                    target
                ),
            )
        }
    ...
    let incremental = debugging_opts
        .incremental
        .as_ref()
...
mod dep_tracking {
    ...
    use std::path::PathBuf;
    use std::collections::hash_map::DefaultHasher;
    use super::{CrateType, DebugInfoLevel, ErrorOutputType, Externs, OptLevel, OutputTypes,
                Passes, Sanitizer};
    use syntax::feature_gate::UnstableFeatures;
    ...
    impl DepTrackingHash for SearchPaths {
        fn hash(&self, hasher: &mut DefaultHasher, _: ErrorOutputType) {
            let mut elems: Vec<_> = self.iter(PathKind::All).collect();
            elems.sort();
    ...
    pub fn stable_hash(
        sub_hashes: BTreeMap<&'static str, &DepTrackingHash>,
...
mod tests {
    ...
    fn test_externs_tracking_hash_different_values() {
        ...
        v3.externs = Externs::new(mk_map(vec![
            ...
            (
                String::from("d"),
                mk_set(vec![String::from("X"), String::from("f")]),
            ),
        ]));
    ...
    fn test_search_paths_tracking_hash_different_values() {
        ...
        // Native changed
        v2.search_paths
            .add_path("native=XXX", super::ErrorOutputType::Json(false));
        v2.search_paths
            .add_path("crate=def", super::ErrorOutputType::Json(false));
        v2.search_paths
            .add_path("dependency=ghi", super::ErrorOutputType::Json(false));
        ...
        v2.search_paths
            .add_path("native=abc", super::ErrorOutputType::Json(false));
        v2.search_paths
            .add_path("crate=XXX", super::ErrorOutputType::Json(false));
        v2.search_paths
            .add_path("dependency=ghi", super::ErrorOutputType::Json(false));
        v2.search_paths
            .add_path("framework=jkl", super::ErrorOutputType::Json(false));
        ...
        v3.search_paths
            .add_path("crate=def", super::ErrorOutputType::Json(false));
        v3.search_paths
            .add_path("dependency=XXX", super::ErrorOutputType::Json(false));
        v3.search_paths
            .add_path("framework=jkl", super::ErrorOutputType::Json(false));
        v3.search_paths
            .add_path("all=mno", super::ErrorOutputType::Json(false));
        ...
        v4.search_paths
            .add_path("dependency=ghi", super::ErrorOutputType::Json(false));
        v4.search_paths
            .add_path("framework=XXX", super::ErrorOutputType::Json(false));
        v4.search_paths
            .add_path("all=mno", super::ErrorOutputType::Json(false));
        ...
        v5.search_paths
            .add_path("framework=jkl", super::ErrorOutputType::Json(false));
        v5.search_paths
            .add_path("all=XXX", super::ErrorOutputType::Json(false));
