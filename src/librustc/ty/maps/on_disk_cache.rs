...
use hir;
use hir::def_id::{
    CrateNum, DefId, DefIndex, LocalDefId, LOCAL_CRATE, RESERVED_FOR_INCR_COMP_CACHE,
};
...
impl<'sess> OnDiskCache<'sess> {
        ...
        T: Decodable,
    {
        ...
        self.cnum_map
            .init_nonlocking_same(|| Self::compute_cnum_map(tcx, &self.prev_cnums[..]));
    ...
    fn specialized_decode(&mut self) -> Result<Span, Self::Error> {
        ...
        let ctxt = match expn_info_tag {
            ...
            TAG_EXPANSION_INFO_INLINE => {
                ...
                self.synthetic_expansion_infos
                    .borrow_mut()
                    .insert(pos, ctxt);
                ctxt
            }
...
where
    ...
    Q::Value: Encodable,
{
    let desc = &format!("encode_query_results for {}", unsafe {
        ::std::intrinsics::type_name::<Q>()
    });
