...
use syntax_pos::{BytePos, FileMap, Span, DUMMY_SP};
use syntax_pos::hygiene::{ExpnInfo, Mark, SyntaxContext};
use ty;
        ...
        E: ty_codec::TyEncoder,
    {
        ...
        tcx.dep_graph.with_ignore(|| {
            ...
            let diagnostics_index = {
                ...
                for (dep_node_index, diagnostics) in self.current_diagnostics.borrow().iter() {
    ...
    fn file_index_to_file(&mut self, index: FileMapIndex) -> Rc<FileMap> {
        ...
        file_index_to_file
            ...
            .or_insert_with(|| {
                ...
                codemap
                    .filemap_by_stable_id(stable_id)
...
impl<'a, 'tcx, 'x> SpecializedDecoder<Span> for CacheDecoder<'a, 'tcx, 'x> {
    fn specialized_decode(&mut self) -> Result<Span, Self::Error> {
        ...
        let ctxt = match expn_info_tag {
            TAG_NO_EXPANSION_INFO => SyntaxContext::empty(),
    ...
    E: 'enc + ty_codec::TyEncoder,
{
    fn specialized_encode(&mut self, span: &Span) -> Result<(), Self::Error> {
        ...
        let (file_lo, line_lo, col_lo) = match self.codemap.byte_pos_to_line_and_col(span_data.lo) {
            Some(pos) => pos,
            None => {
                return TAG_INVALID_SPAN.encode(self);
            }
