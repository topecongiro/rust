...
pub use self::context::{keep_local, tls, GlobalArenas, TyCtxt};
...
pub type PolyRegionOutlivesPredicate<'tcx> = PolyOutlivesPredicate<
    ty::Region<'tcx>,
    ty::Region<'tcx>,
>;
...
impl<'a, 'gcx, 'tcx> AdtDef {
    ...
    pub fn variant_of_def(&self, def: Def) -> &VariantDef {
        match def {
            ...
            | Def::TyAlias(..)
            | Def::AssociatedTy(..)
            | Def::SelfTy(..) => self.struct_variant(),
...
impl<'a, 'gcx, 'tcx> TyCtxt<'a, 'gcx, 'tcx> {
    ...
    pub fn expr_is_lval(self, expr: &hir::Expr) -> bool {
        match expr.node {
            ...
            hir::ExprType(ref e, _) => self.expr_is_lval(e),
    ...
    pub fn expect_variant_def(self, def: Def) -> &'tcx VariantDef {
        match def {
            ...
            Def::Struct(did) | Def::Union(did) => self.adt_def(did).struct_variant(),
