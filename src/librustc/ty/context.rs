...
use middle::cstore::{CrateStore, EncodedMetadataHashes, LinkMeta};
...
impl<'a, 'gcx, 'tcx> TyCtxt<'a, 'gcx, 'tcx> {
    ...
    pub fn stability(self) -> Rc<stability::Index<'tcx>> {
        ...
        // today.
        self.dep_graph
            .with_ignore(|| self.stability_index(LOCAL_CRATE))
    }
        ...
        E: ty::codec::TyEncoder,
    {
        self.on_disk_query_result_cache
            .serialize(self.global_tcx(), self.cstore, encoder)
    }
}
...
impl<'a, 'gcx, 'tcx> TyCtxt<'a, 'gcx, 'tcx> {
    ...
    pub fn safe_to_unsafe_fn_ty(self, sig: PolyFnSig<'tcx>) -> Ty<'tcx> {
        ...
        self.mk_fn_ptr(sig.map_bound(|sig| {
            ty::FnSig {
    ...
    {
        inputs.chain(iter::once(output)).intern_with(|xs| {
            ty::FnSig {
...
struct NamedRegionMap {
    ...
    object_lifetime_defaults:
        FxHashMap<DefIndex, Rc<FxHashMap<ItemLocalId, Rc<Vec<ObjectLifetimeDefault>>>>>,
}
