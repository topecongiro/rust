...
pub trait TypeFoldable<'tcx>: fmt::Debug + Clone {
    ...
    fn has_erasable_regions(&self) -> bool {
        self.has_type_flags(
            TypeFlags::HAS_RE_EARLY_BOUND | TypeFlags::HAS_RE_INFER | TypeFlags::HAS_FREE_REGIONS,
        )
    }
    fn is_normalized_for_trans(&self) -> bool {
        !self.has_type_flags(
            TypeFlags::HAS_RE_EARLY_BOUND | TypeFlags::HAS_RE_INFER | TypeFlags::HAS_FREE_REGIONS
                | TypeFlags::HAS_TY_INFER | TypeFlags::HAS_PARAMS
                | TypeFlags::HAS_NORMALIZABLE_PROJECTION | TypeFlags::HAS_TY_ERR
                | TypeFlags::HAS_SELF,
        )
    }
