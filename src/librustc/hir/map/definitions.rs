...
#[derive(Copy, Clone, Hash, PartialEq, Eq, PartialOrd, Ord, Debug, RustcEncodable,
         RustcDecodable)]
...
impl DefPathData {
    pub fn get_opt_name(&self) -> Option<InternedString> {
        ...
        match *self {
            ...
            Impl | CrateRoot | Misc | ClosureExpr | StructCtor | AnonConst | ImplTrait => None,
        }
    }
    ...
    pub fn as_interned_str(&self) -> InternedString {
        ...
        let s = match *self {
            ...
            | EnumVariant(name)
            | Field(name)
            | GlobalMetaData(name) => return name,
