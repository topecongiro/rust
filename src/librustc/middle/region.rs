...
#[derive(Clone, PartialEq, PartialOrd, Eq, Ord, Hash, Debug, Copy, RustcEncodable,
         RustcDecodable)]
pub enum ScopeData {
...
#[derive(Clone, PartialEq, PartialOrd, Eq, Ord, Hash, RustcEncodable, RustcDecodable, Debug,
         Copy)]
...
fn resolve_local<'a, 'tcx>(
    ...
    fn record_rvalue_scope_if_borrow_expr<'a, 'tcx>(
        ...
        match expr.node {
            ...
            hir::ExprArray(ref subexprs) | hir::ExprTup(ref subexprs) => {
...
fn region_scope_tree<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>, def_id: DefId) -> Lrc<ScopeTree> {
