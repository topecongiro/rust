...
pub use lint::context::{
    check_ast_crate, check_crate, BufferedEarlyLint, EarlyContext, FutureIncompatibleInfo,
    LateContext, LintContext, LintStore,
};
...
fn lint_levels<'a, 'tcx>(tcx: TyCtxt<'a, 'tcx, 'tcx>, cnum: CrateNum) -> Lrc<LintLevelMap> {
